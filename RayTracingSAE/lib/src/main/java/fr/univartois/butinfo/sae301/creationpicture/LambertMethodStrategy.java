...
/**
 * The `LambertMethodStrategy` class implements the `IColorStrategy` interface
 * and defines a Lambertian reflection model for calculating the color of a
 * scene object. It takes into account the interaction of light sources with the
 * object.
 *
...
public class LambertMethodStrategy implements IColorStrategy {
	...
	public static fr.univartois.butinfo.sae301.opetriplet.Color CalculateLd(Vector normal, List<Light> lights,
			Point intersectionPoint) {
		fr.univartois.butinfo.sae301.opetriplet.Color color3 = new fr.univartois.butinfo.sae301.opetriplet.Color(0, 0,
				0);
	...
	public static Color calculateColor(Vector normal, List<Light> lights, Point intersectionPoint,
		...
		float g;
		float b;
		fr.univartois.butinfo.sae301.opetriplet.Color colordiff = BasicStrategy.calculateColor(normal, lights,
		...
		fr.univartois.butinfo.sae301.opetriplet.Color color2 = colordiff.schurProduct(colorLd)
				.add(intersectionPoint.getColor());
